...
CexDlg::CexDlg(CWnd* pParent /*=nullptr*/)
	: CDialogEx(IDD_EX_DIALOG, pParent)
...
void CexDlg::DoDataExchange(CDataExchange* pDX)
{
	CDialogEx::DoDataExchange(pDX);
...
BEGIN_MESSAGE_MAP(CexDlg, CDialogEx)
	ON_WM_SYSCOMMAND()
	ON_WM_PAINT()
	ON_WM_QUERYDRAGICON()
	ON_BN_CLICKED(IDC_BUTTON1, &CexDlg::OnBnClickedButton1)
	ON_BN_CLICKED(IDC_BUTTON2, &CexDlg::OnBnClickedButton2)
END_MESSAGE_MAP()
...
void CexDlg::OnSysCommand(UINT nID, LPARAM lParam)
{
...
//  이 함수를 호출합니다.
HCURSOR CexDlg::OnQueryDragIcon()
{
...
void CexDlg::OnBnClickedButton2()
{
	// TODO: 여기에 컨트롤 알림 처리기 코드를 추가합니다.
	UpdateData();
